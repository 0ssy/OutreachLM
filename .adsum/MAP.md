...
.pytest_cache/
  ...
  CACHEDIR.TAG
models/
  outreachlm_phase_h_runtime.pkl
  outreachlm_phase_i_runtime.pkl
  phase_g_hybrid_runtime.pkl
scripts/
...
src/phase_m_cluster/
  ...
  monitor.py
  telemetry.py
src/restricted_backward/
  harness.py
  methods.py
  run_true_restricted.py
  true_restricted.py
(30 doc file(s) omitted)
...
tests/ — 48 more file(s) (use list_files to enumerate)
(27 directories omitted)
