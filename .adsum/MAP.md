...
.pytest_cache/
  .gitignore
  CACHEDIR.TAG
experiments/b1-smoke/
  legacy-smoke-tokenizer.json
  legacy-smoke.pt
experiments/b1-smoke/corpus/
  sample.txt
experiments/b1-smoke/v4-run/
  tokenizer.json
  v4_config.json
  v4_training_summary.json
  v4-best-rollout.pt
  v4-checkpoint-step-00001.pt
  v4-final.pt
scripts/
...
tests/
  ...
  test_distributed_semantics.py
  test_evaluation_profiles.py
  test_experiment_config_cli.py
